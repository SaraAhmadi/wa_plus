...
from src.database.models.role import Role # For type hinting and relationship path
from src.schemas.token import TokenData
from src.database.models.user import User # Your SQLAlchemy User model
...
# from src.services.user_service import UserService # Ideal
from src.security.token_utils import decode_access_token
