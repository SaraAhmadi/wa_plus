...
# Or from src.worker.celery_app import celery_app if running from project root context
...
#     from src.database.session import AsyncSessionFactory # For standalone task session
#     import asyncio
#
#     async def _run():
