...
from src.dependencies import get_db, get_current_active_superuser
# from src.dependencies.rbac import CheckPermissions # Example if using permission strings
from src.database.models.user import User as UserModel  # SQLAlchemy model
from src.schemas.user import User as UserSchema, UserCreate, UserUpdate
from src.schemas.base_schema import PaginatedResponse  # For paginated list response
