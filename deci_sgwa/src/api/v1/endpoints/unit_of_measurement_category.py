...
from src.dependencies import get_db, get_current_user # Standard dependencies
from src.schemas.unit_of_measurement_category import (
...
from src.services import unit_of_measurement_category_service as uom_category_service
